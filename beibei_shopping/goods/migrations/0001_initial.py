# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2018-10-20 03:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('path', models.ImageField(default='static/images/goods/default.png', upload_to='static/images/goods', verbose_name='商品名称')),
                ('status', models.BooleanField(default=False, verbose_name='是否显示该图片')),
                ('intro', models.TextField(blank=True, null=True, verbose_name='商品描述')),
        ...
        migrations.AddField(
            model_name='goods',
            name='goodstype',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.GoodType', verbose_name='商品类型'),
        ),
        migrations.AddField(
            model_name='goods',
            name='stores',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.Store', verbose_name='商品所属店铺'),
        ),
    ]
